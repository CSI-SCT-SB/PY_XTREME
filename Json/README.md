...
1. [**Blog by geeksforgeeks**](https://www.geeksforgeeks.org/python-json/)
1. [**Blog by w3schools**](https://www.w3schools.com/python/python_json.asp)

## Youtube Tutorials:
1. [**Tutorial video**](https://youtu.be/jABj-SEhtBc)
1. [**JSON playlist**](https://youtube.com/playlist?list=PL2VXyKi-KpYs_f1gu30AGqy0H6x97Vomf)
1. [**Working with JSON data**](https://youtu.be/9N6a-VLBa2I)

## For Queries Contact Maintainer ☎️:
[**Harrel Alex Jacob**](https://wa.me/<+91 80787 67301>)
